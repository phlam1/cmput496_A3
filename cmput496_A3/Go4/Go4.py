...
parser.add_argument('-no_ac', help='disable atari capture policy', action='store_true')
parser.add_argument('-no_ad', help='disable atari defence policy', action='store_true')
...
if __name__=='__main__':
    ...
    c.go_engine.use_ad = not no_ad
    c.go_engine.use_ac = not no_ac
    c.start_connection()
